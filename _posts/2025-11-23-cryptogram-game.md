...
const QUOTES = {
  tech: [
    ...
    "There are two ways of constructing software: make it so simple there are no deficiencies, or make it so complicated there are no obvious deficiencies.",
  ...
  rants: [
    ...
    "Software developers like to solve problems. If there are no problems readily available, they will create their own.",
    "Beware of bugs in the above code; I have only proved it correct, not tried it.",
    "The determined programmer can write FORTRAN programs in any language.",
    "Some people, when confronted with a problem, think: I know, I'll use regular expressions. Now they have two problems.",
    "A computer lets you make more mistakes faster than any other invention in human history, with the possible exceptions of handguns and tequila.",
    "Writing the first ninety percent of a computer program takes ninety percent of the time. The remaining ten percent also takes ninety percent of the time.",
  ...
  bugs: [
    ...
    "QA signed off on this.",
    "The PM changed the requirements.",
    "That's legacy code, nobody touches that.",
  ...
  profanity: [
    ...
    "GraphQL is REST for people who think making one hundred database queries per request is a feature.",
    "Scrum masters are project managers who learned three buzzwords and call it a methodology.",
    "TypeScript is JavaScript for people who don't trust themselves or anyone else.",
    "Electron apps are just shitty websites that eat gigabytes of RAM and call it native.",
    "Machine learning is statistics for people who failed math but have expensive GPUs.",
    "DevOps is what happens when you fire the sysadmin and blame the developers.",
    "Pair programming is hell with a witness.",
    "Code reviews are where dreams go to die and egos go to argue about semicolons.",
    "Sprint planning is two hours of my life I'll never get back to plan work that will change by Tuesday.",
    "The blockchain will revolutionize everything except the things that actually need revolutionizing.",
    "NoSQL databases are for people who think data integrity is someone else's problem.",
    "Serverless still runs on servers, you just pay more and understand less.",
    "Web3 is the same scam as Web2 but with more environmental damage.",
    "CI/CD pipelines are glorified cron jobs with YAML and attitude.",
    "Clean code is what you write when you're not being graded on velocity.",
    "Technical debt is the only debt that grows faster than student loans.",
    "The test pyramid is a fantasy; the reality is a test ice cream cone that melts in production.",
    "Minimum viable product means half-assed prototype that somehow made it to customers.",
    "Monorepos are for teams that miss the chaos of merge conflicts.",
    "Open source means free as in you're now responsible for supporting it forever.",
    "Cloud native means spending a fortune to run the same code with more steps.",
    "The metaverse is Second Life with better marketing and worse graphics.",
    "API versioning is admitting you fucked up the first time but can't fix it now.",
    "Design patterns are fancy names for solutions we keep reimplementing because we forgot the last time.",
    "Full stack developer means you're mediocre at everything instead of good at something."
  ]
};
